...
a.toFixed(2)+" kg<br>\n                 <strong>Water Required:</strong> "+b.toFixed(2)+" L<br>\n                 <strong>Estimated Final ABV:</strong> "+c.toFixed(1)+"% (assuming FG = 1.010)"))})});$("a[data-mail]").on("click",function(){window.location="mailto:"+$(this).data("mail")+"@paulwillard.nz?subject=Contact from website"});$('a[target="_blank"]').each(function(){$(this).attr("rel","noreferrer noopener")});
