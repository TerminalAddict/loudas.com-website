...
if (isset($_GET['start'])) {
	if (preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/",$_GET['start'])) {
		...
		$start_time = strtotime("2025-06-02");
	}
} else { $start_time = strtotime("2025-06-02"); }
...
// display a username. Display "Paul & Robyn" by default
if(isset($_GET['name'])) {
...
$rImg = ImageCreateFromJPEG( "couple_journey_blank.jpg" );
