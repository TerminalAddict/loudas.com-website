---
layout: page
title: The Fahaka Pufffer
image: fahaka_tank.jpg
comments: false
author: paul
description: The Fahaka Tank
---
...
<h1>{{ page.title }}</h1>
<p>
This is my Fahaka Puffer.<br />
S/He has a large pleco in with him/her<br />
I hope that's OK, and the pleco doesn't get eaten. 🤣<br />
...
{% for fish in site.data.fahaka_fish %}
